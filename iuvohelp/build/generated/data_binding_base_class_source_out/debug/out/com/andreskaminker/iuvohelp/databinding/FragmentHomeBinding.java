...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView actionDisplay;

  @NonNull
  public final ConstraintLayout coordinatorLayout2;

  private FragmentHomeBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView actionDisplay, @NonNull ConstraintLayout coordinatorLayout2) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.actionDisplay;
      RecyclerView actionDisplay = rootView.findViewById(id);
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, actionDisplay,
          coordinatorLayout2);
    }
