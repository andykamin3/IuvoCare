...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.andreskaminker.iuvohelp.modules.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.andreskaminker.iuvohelp.modules.GlideOptions().apply(toSet));
    }
  }
}
